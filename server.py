...
def get_fa_transactions() -> dict:
    ...
    prompt = (
        ...
        "- Date of acquiring the interest (normalize to YYYY-MM-DD) - Entry Date coumn in pdf\n"
        "- Initial value of the investment (numeric, INR) - Book Value in pdf is in USD convert to INR \n"
        "- units (numeric)\n"
        "- unit_price (numeric, INR ) Unit Label Price in pdf is in USD convert to INR \n"
